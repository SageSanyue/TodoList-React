...
var APP_ID = 'Ccm488O3B6M5kTnrGiDGqGsu-gzGzoHsz'
var APP_KEY = 'NJQPLazC78Y8EkcGQ46wnOvj'
AV.init({
  appId: APP_ID,
  appKey: APP_KEY
})
...
export const TodoModel = {
  ...
  create(item, user, successFn, errorFn){
    let Todo = AV.Object.extend(user.username)
    let todo = new Todo()
...
// 文档 https://leancloud.cn/docs/leanstorage_guide-js.html#更新对象
  ...
  destroy(user, item, successFn, errorFn){
